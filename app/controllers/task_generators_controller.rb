class TaskGeneratorsController < ApplicationController
  ...
  private
    ...
    def task_generator_params
      params.require(:task_generator).permit(:description, :category_id, :mandatory, :every_n, :sun, :mon, :tues, :wed, :thurs, :fri, :sat, :part_of_day, :custom_time, :last_run, :look_ahead)
    end
end
